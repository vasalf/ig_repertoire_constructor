...
bool InputData::read_rcm_file(std::string filename) {
...
void InputData::add_read_record(std::string s_id, Read &&r) {
...
bool InputData::ReadData(const IgComponentSplitterConfig &cfg) {
